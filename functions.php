...
function fse_setup() {
	/*
		...
		* If you're building a theme based on FSE, use a find and replace
...
function fse_scripts() {
	wp_enqueue_style( 'fse-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'fse-style', 'rtl', 'replace' );

	wp_enqueue_script( 'fse-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
...
add_action('init', 'registerTestimonialPostType');